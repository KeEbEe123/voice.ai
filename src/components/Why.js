      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap justify-center -mx-4">
          <div className="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8">
            <div className="bg-gray-800 rounded-lg p-6 flex flex-col items-center border-2 border-solid border-red-400">
              <svg
              ...
              <p className="text-lg font-bold text text-center pt-5">
                Time Saving
              </p>
          ...
          <div className="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8">
            <div className="bg-gray-800 rounded-lg p-6 flex flex-col items-center border-2 border-solid border-red-400 justify-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="50"
                height="50"
              ...
              <p className="text-lg text-center pt-5 font-bold">Ease of Use</p>
              <p className="text-sm text-center pt-3">
                Sing a scale in any range you're comfortable in and obtain your
                vocal key.
              </p>
